...
/**
 * Devuelve el puntaje obtenido dependiendo de los intentos y de las letras de la palabra
 * @param int $intento
...
{
  //int $i, $puntaje
  //array $vocales, $constonantesHastaM, $consonantesDespuesM
  $puntaje = 0;
  $vocales = ["a","e","i","o","u"];
...
function jugarWordix($palabraWordix, $nombreUsuario)
{
    ...
    if ($ganoElIntento) {
        $nroIntento--;
        $puntaje = obtenerPuntajeWordix($nroIntento,strtolower($palabraWordix));
